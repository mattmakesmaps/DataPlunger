...
if __name__ == '__main__':
    ...
    config_path = '/home/mkenny/Projects/DataPlunger/sample_configs/multi_reader.json'
    collectionConfig = Configuration()
    collectionConfig.parse_config(config_path)

    solos = Controller(collectionConfig, "WACensusConfigSolos")
    combined = Controller(collectionConfig, "WACensusConfigCombined")
